...
# let's set early stopping value

# we mean if model error exceeds this value, stop the process!
...
for epoch in range(10):
  ...
  final_epoch_error =  model_output - np.dot(model_inputs, model_weights)

  error_l.append(final_epoch_error)

  if final_epoch_error > early_stopping:
    break
